...
- (NSString *)pathForDomain:(GSFileDirDomain)aDirDomain;
{
    ...
    switch (aDirDomain)
    {
        ...
        case GSFileDirDomain_User:
        {
            ...
            break;
        case GSFileDirDomain_CurUser:
        {
            path = [self pathForDomain:GSFileDirDomain_User];
//            NSString *strUserId = [[GSDataEngine shareEngine] currentUserIDString];
            
            path = [path stringByAppendingPathComponent:@"11111"];
        }            break;
        default:
            break;
    }
...
{
    @try {
        NSString *dir = [self pathForDomain:GSFileDirDomain_CurUser];
